...
!(function (e, t) {
  ...
  return (function e() {
    ...
    if (((n.version = '2.0.15'), (n.removed = []), !t || !t.document || 9 !== t.document.nodeType))
    ...
    var Je = function (e) {
      ...
      tt = function (e) {
        var t = void 0
        if ((et('beforeSanitizeElements', e, null), Qe(e))) return Ye(e), !0
        if (h(e.nodeName, /[\u0080-\uFFFF]/)) return Ye(e), !0
        var r = g(e.nodeName)
        if (
          (et('uponSanitizeElement', e, { tagName: r, allowedTags: ve }),
      ...
      nt = function (e, t, n) {
        if (Ce && ('id' === t || 'name' === t) && (n in l || n in Ke)) return !1
        if (Le && A(pe, t));
        else if (ke && A(me, t));
        else {
      ...
      rt = function (e) {
        ...
        var c = e.attributes
        if (c) {
          var s = { attrName: '', attrValue: '', keepAttr: !0, allowedAttributes: Te }
          for (l = c.length; l--; ) {
            var u = (t = c[l]),
              m = u.name,
              h = u.namespaceURI
            if (
              ...
              if ('name' === i && 'IMG' === e.nodeName && c.id)
                (a = c.id), (c = y(c, [])), Xe('id', e), Xe(m, e), d(c, a) > l && e.setAttribute('id', a.value)
              else {
                if ('INPUT' === e.nodeName && 'type' === i && 'file' === o && s.keepAttr && (Te[i] || !Se[i])) continue
                'id' === m && e.setAttribute(m, ''), Xe(m, e)
              }
              if (s.keepAttr)
                if (Ee && A(/\/>/i, o)) Xe(m, e)
                else if (A(/svg|math/i, e.namespaceURI) && A(x('</(' + f(r(je), '|') + ')', 'i'), o)) Xe(m, e)
                else {
      ...
      ot = function e(t) {
        ...
        for (et('beforeSanitizeShadowDOM', t, null); (n = r.nextNode()); )
          et('uponSanitizeShadowNode', n, null), tt(n) || (n.content instanceof c && e(n.content), rt(n))
    ...
    return (
      (n.sanitize = function (e, r) {
        ...
        if ((Ne || Ve(r), (n.removed = []), 'string' == typeof e && (Ie = !1), Ie));
          ...
          if (!Re && !Me && !De && -1 === e.indexOf('<')) return te && He ? te.createHTML(e) : e
          if (!(o = $e(e))) return Re ? null : ne
        }
        o && Oe && Ye(o.firstChild)
        for (var d = Je(Ie ? e : o); (l = d.nextNode()); )
          (3 === l.nodeType && l === s) || tt(l) || (l.content instanceof c && ot(l.content), rt(l), (s = l))
        ...
        return Me && ((f = v(f, de, ' ')), (f = v(f, fe, ' '))), te && He ? te.createHTML(f) : f
      }),
