    ...
    function (t, e, r) {
      ...
      var St = kt,
        ...
        Ct = function (t, e, r, a, n) {
          ...
          if (((t = o.value), s)) {
            ...
            'undefined' != typeof console &&
              console.warn("No character metrics for '" + t + "' in style '" + e + "' and mode '" + r + "'"),
            ...
            for (
              var r = (function (t) {
                  if ('individualShift' === t.positionType) {
                    for (
                      var e = t.children, r = [e[0]], a = -e[0].shift - e[0].elem.depth, n = a, i = 1;
                      i < e.length;
                      i++
                    ) {
      ...
      _t({
        ...
        htmlBuilder: function (t, e) {
          ...
          i.classes.push('x-arrow-pad'),
            t.below &&
              ((n = e.havingStyle(a.sub())), (r = Dt.wrapFragment(oe(t.below, n, e), e)).classes.push('x-arrow-pad'))
          var o,
            s = Be(t, e),
      ...
      _t({
        ...
        _t({
          ...
          mathmlBuilder: function (t, e) {
            ...
            return (
              t.newLine &&
                (r.setAttribute('linebreak', 'newline'), t.size && r.setAttribute('height', Tt(t.size, e) + 'em')),
              r
            )
          }
        })
      var De = {
        ...
        Fe = function (t, e, r, a) {
          ...
          null == n &&
            ((r.noexpand = !0), (n = { tokens: [r], numArgs: 0, unexpandable: !t.gullet.isExpandable(r.text) })),
      ...
      _t({
        ...
        handler: function (t) {
          ...
          if (De[a.text])
            return (
              ('\\global' !== r && '\\\\globallong' !== r) || (a.text = De[a.text]), Ce(e.parseFunction(), 'internal')
            )
        ...
        ir = function (t, e) {
          ...
          return (
            'small' === i.type
              ? (t < 1 ? (o = 1) : t < 1.4 && (o = 0.7),
                (h = (1 + s) / o),
                ((r = je('sqrtMain', (l = (1 + s + 0.08) / o), (m = 1e3 + 1e3 * s + 80), s, e)).style.minWidth =
                  '0.853em'),
                (a = 0.833 / o))
              : 'large' === i.type
              ? ((m = 1080 * Je[i.size]),
      ...
      _t({
        ...
        _t({
          ...
          mathmlBuilder: function (t, e) {
            ...
            return (
              a.setAttribute('fence', 'true'), a.setAttribute('lspace', '0.05em'), a.setAttribute('rspace', '0.05em'), a
            )
          }
        })
      var pr = function (t, e) {
      ...
      var yr = function (t, e) {
          ...
          for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
            for (var R = I[q] || {}, E = !0; 'separator' === R.type; ) {
              if (
                (E ||
                  (((C = Dt.makeSpan(['arraycolsep'], [])).style.width = e.fontMetrics().doubleRuleSep + 'em'),
                  O.push(C)),
        ...
        Or = function (t, e) {
          ...
          if (
            ...
            a.size === w.DISPLAY.size || 'display' === t.size
              ...
              : (m > 0 ? ((u = e.fontMetrics().num2), (p = c)) : ((u = e.fontMetrics().num3), (p = 3 * c)),
      ...
      var Pr = function (t, e) {
        var r,
          ...
          n = e.style
        'supsub' === t.type
          ? ((r = t.sup ? oe(t.sup, e.havingStyle(n.sup()), e) : oe(t.sub, e.havingStyle(n.sub()), e)),
        ...
        mathmlBuilder: function (t, e) {
          ...
          if (
            (t.totalheight.number > 0 &&
              ((n = (n = Tt(t.totalheight, e) - a).toFixed(2)), r.setAttribute('valign', '-' + n + 'em')),
      ...
      var Fr = function (t, e, r, a, n, i, o) {
        ...
        Gr = function (t, e) {
          var r
          if (t.symbol)
            (r = new me('mo', [pe(t.name, t.mode)])), c.contains(Vr, t.name) && r.setAttribute('largeop', 'false')
      ...
      jt({
        ...
        htmlBuilder: function (t, e) {
          ...
          if (n) {
            var k =
              t.base && 'op' === t.base.type && t.base.name && ('\\oiint' === t.base.name || '\\oiiint' === t.base.name)
          ...
          if (a && n) {
            ...
            ;(u = Math.max(u, i, a.depth + 0.25 * m.xHeight)),
              (x = Dt.makeVList(
                { positionType: 'shift', positionData: -u, children: [{ type: 'elem', elem: a, marginRight: b }] },
                e
              ))
          }
      ...
      pa(
        '\\LaTeX',
        '\\textrm{\\html@mathml{L\\kern-.36em\\raisebox{' + va + '}{\\scriptstyle A}\\kern-.15em\\TeX}{LaTeX}}'
      ),
        pa(
          '\\KaTeX',
          '\\textrm{\\html@mathml{K\\kern-.17em\\raisebox{' + va + '}{\\scriptstyle A}\\kern-.15em\\TeX}{KaTeX}}'
        ),
          ...
          return (
            ...
            (e.expandTokens = function (t) {
              ...
              for (this.pushTokens(t); this.stack.length > r; ) {
                ...
                a instanceof n &&
                  (a.treatAsRelax && ((a.noexpand = !1), (a.treatAsRelax = !1)), e.push(this.stack.pop()))
              }
              return e
            }),
            ...
            (e.formLigatures = function (t) {
              for (var e = t.length - 1, r = 0; r < e; ++r) {
                ...
                '-' === i &&
                  '-' === t[r + 1].text &&
                  (r + 1 < e && '-' === t[r + 2].text
                    ? (t.splice(r, 3, { type: 'textord', mode: 'text', loc: a.range(n, t[r + 2]), text: '---' }),
                      (e -= 2))
                    : (t.splice(r, 2, { type: 'textord', mode: 'text', loc: a.range(n, t[r + 1]), text: '--' }),
                      (e -= 1))),
                  ("'" !== i && '`' !== i) ||
                    t[r + 1].text !== i ||
                    (t.splice(r, 2, { type: 'textord', mode: 'text', loc: a.range(n, t[r + 1]), text: i + i }),
                    (e -= 1))
              }
            }),
