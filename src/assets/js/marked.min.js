...
!(function (e, t) {
      ...
      return (
        ...
        (t.code = function (e, t) {
          ...
          if (n) {
            ...
            return { type: 'code', raw: n[0], codeBlockStyle: 'indented', text: this.options.pedantic ? i : q(i, '\n') }
          }
        }),
        (t.fences = function (e) {
        ...
        (t.codespan = function (e) {
          ...
          if (t) {
            ...
            return (
              r && i && (n = n.substring(1, n.length - 1)), (n = C(n, !0)), { type: 'codespan', raw: t[0], text: n }
            )
          }
        }),
        (t.br = function (e) {
  ...
  ;(F.punctuation = L(F.punctuation)
    ...
    (F.tag = L(F.tag).replace('comment', B._comment).replace('attribute', F._attribute).getRegex()),
    (F._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    (F._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/),
    (F._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
  ...
  var H = (function () {
      function n(e) {
        ...
        this.options.pedantic
          ...
          : this.options.gfm && ((t.block = W.gfm), this.options.breaks ? (t.inline = X.breaks) : (t.inline = X.gfm)),
        ...
        (i.inlineTokens = function (e, t, n, r, i) {
          ...
          for (; e; )
            if ((s = this.tokenizer.escape(e))) (e = e.substring(s.raw.length)), t.push(s)
              ...
              (e = e.substring(s.raw.length)), (n = s.inLink), (r = s.inRawBlock), t.push(s)
              ...
              (e = e.substring(s.raw.length)), (s.tokens = this.inlineTokens(s.text, [], n, r)), t.push(s)
              ...
              if ((s = this.tokenizer.inlineText(e, r, G)))
                (e = e.substring(s.raw.length)), (i = s.raw.slice(-1)), t.push(s)
              else if (e) {
            ...
            switch ((u = e[w]).type) {
              ...
              case 'table':
                for (a = o = '', i = u.header.length, n = 0; n < i; n++)
                  a += this.renderer.tablecell(this.parseInline(u.tokens.header[n]), { header: !0, align: u.align[n] })
                for (o += this.renderer.tablerow(a), c = '', i = u.cells.length, n = 0; n < i; n++) {
                  for (a = '', s = (l = u.tokens.cells[n]).length, r = 0; r < s; r++)
                    a += this.renderer.tablecell(this.parseInline(l[r]), { header: !1, align: u.align[r] })
