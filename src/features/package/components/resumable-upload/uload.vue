...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const preprocessFile = async r => {
      console.log('preprocessFile')

      const { uuid, short_uuid } = await registerPackage(r.file)
      console.log(uuid, short_uuid)
    ...
    const preprocess = async r => {
      ...
      const { uuid } = await registerChunkPackage(r)
    ...
    const registerPackage = async file => {
    ...
    const registerChunkPackage = async r => {
      console.log('registerChunkPackage')
