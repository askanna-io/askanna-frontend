<template>
  <v-card class="ask-anna--editor" flat>
    <editor-menu-bar class="ma-2" v-if="editable" :editor="editor" v-slot="{ commands, isActive }">
      <div class="menubar">
        <v-btn
          small
          :text="!isActive.bold()"
        ...
        <v-btn small class="mr-1" color="primary" text @click="commands.horizontal_rule">
          <v-icon>mdi-color-helper</v-icon>
        </v-btn>

        <v-btn small class="mr-1" text color="primary" @click="commands.undo">
          <v-icon>mdi-undo</v-icon>
        </v-btn>

        <v-btn small class="mr-1" text color="primary" @click="commands.redo">
